...
if(SidebarView)    
    render(
        <div>
          <div>This page tests TW1.2 Basic Rendering for a SidebarView. We render SidebarView twice. The first rendering sets the number prop to 5. The second rendering checks whether the - button gets disabled when the number prop is 1.
